function fullAvatarEditor() {
	...
	var file			= basePath+'/resources/common/libs/avatar/fullAvatarEditor.swf';		//flash文件的路径
	var	version			= "10.1.0";						//播放该flash所需的最低版本
	var	expressInstall	= basePath+'/resources/common/libs/avatar/expressInstall.swf';			//expressInstall.swf的路径
