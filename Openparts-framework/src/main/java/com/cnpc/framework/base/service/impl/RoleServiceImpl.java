...
public class RoleServiceImpl extends BaseServiceImpl implements RoleService {
    ...
    public Set<String> getRoleCodeSet(String userId) {
        /*
         * String sql= PropertiesUtil.getValue("shiro.sql.roles"); Map<String,Object>
         * params=new HashMap<String,Object>(); params.put("param",userId);
         * List<Map<String,Object>> list=super.findMapBySql(sql,params); Set<String>
         * retSet=new HashSet<String>(); for (Map map : list) {
         * retSet.add(map.get("code").toString()); } return retSet;
         */
